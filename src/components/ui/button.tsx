...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default: 'bg-primary text-primary-foreground shadow-sm shadow-black/20 hover:-translate-y-0.5 hover:bg-primary/90',
        destructive:
          'bg-destructive text-white shadow-xs hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60',
        outline:
          'border bg-background/80 shadow-sm hover:-translate-y-0.5 hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50',
        ...
        shine:
          'relative overflow-hidden border border-white/15 bg-white text-zinc-950 shadow-sm shadow-black/30 hover:-translate-y-0.5 hover:bg-zinc-100 before:absolute before:inset-0 before:translate-x-[-120%] before:bg-[linear-gradient(120deg,transparent_20%,rgba(255,255,255,0.75)_50%,transparent_80%)] before:transition-transform before:duration-700 hover:before:translate-x-[120%]',
        soft:
          'border border-white/15 bg-zinc-900/70 text-zinc-100 shadow-sm shadow-black/35 hover:-translate-y-0.5 hover:bg-zinc-800/80',
      },
      size: {
